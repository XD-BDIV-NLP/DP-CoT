...
def main():
    ...
    if not args.skip_evaluation:
        ...
        # python evaluate.py instantiated_configs/ircot_flan_t5_large_2wikimultihopqa____prompt_set_1___bm25_retrieval_count__2___distractor_count__1.jsonnet processed_data/2wikimultihopqa/dev_subsampled.jsonl
