...
def main():
    ...
    # predict_subparser.add_argument("--skip_if_exists", action="store_false", help="skip if final metrics/output exist.")
    ...
    print("***" * 20)
    print("config_filepath is " + str(config_filepath))
    print("***" * 20)
    ...
    # print("***" * 20)
    # print("file_content is " + str(file_content))
    # print("***" * 20)
        ...
        for _prompt_set in ("1", "2", "3"):
            ...
            if not os.path.exists(metrics_file_path):
                ...
                if "para_recall" in metrics and "avg_predicted_paras" in metrics:
                    ...
                    # metric_value = round(metrics["recall"] * 100, 1)
